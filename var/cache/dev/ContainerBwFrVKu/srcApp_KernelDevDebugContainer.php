...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHoldereef4c = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerca9c5 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesc5865 = [
        
    ];

    public function getConnection()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'getConnection', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'getMetadataFactory', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'getExpressionBuilder', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'beginTransaction', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'getCache', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->getCache();
    }

    public function transactional($func)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'transactional', array('func' => $func), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'wrapInTransaction', array('func' => $func), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'commit', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->commit();
    }

    public function rollback()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'rollback', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'getClassMetadata', array('className' => $className), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'createQuery', array('dql' => $dql), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'createNamedQuery', array('name' => $name), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'createQueryBuilder', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'flush', array('entity' => $entity), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'clear', array('entityName' => $entityName), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->clear($entityName);
    }

    public function close()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'close', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->close();
    }

    public function persist($entity)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'persist', array('entity' => $entity), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'remove', array('entity' => $entity), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'refresh', array('entity' => $entity), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'detach', array('entity' => $entity), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'merge', array('entity' => $entity), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'getRepository', array('entityName' => $entityName), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'contains', array('entity' => $entity), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'getEventManager', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'getConfiguration', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'isOpen', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'getUnitOfWork', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'getProxyFactory', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'initializeObject', array('obj' => $obj), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'getFilters', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'isFiltersStateClean', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'hasFilters', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return $this->valueHoldereef4c->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerca9c5 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHoldereef4c) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHoldereef4c = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHoldereef4c->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, '__get', ['name' => $name], $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        if (isset(self::$publicPropertiesc5865[$name])) {
            return $this->valueHoldereef4c->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHoldereef4c;
    ...
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;
    ...
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, '__isset', array('name' => $name), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;
    ...
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, '__unset', array('name' => $name), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;
    ...
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, '__clone', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        $this->valueHoldereef4c = clone $this->valueHoldereef4c;
    }

    public function __sleep()
    {
        $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, '__sleep', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;

        return array('valueHoldereef4c');
    }
    ...
    {
        $this->initializerca9c5 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerca9c5;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerca9c5 && ($this->initializerca9c5->__invoke($valueHoldereef4c, $this, 'initializeProxy', array(), $this->initializerca9c5) || 1) && $this->valueHoldereef4c = $valueHoldereef4c;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHoldereef4c;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHoldereef4c;
    }
}
